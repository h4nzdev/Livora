...
import DwellerSidebar from "../components/DwellerComponents/DwellerSidebar";
import DwellerHeader from "../components/DwellerComponents/DwellerHeader";
import SplashScreen from "../components/SplashScreen";

const DwellerLayout = ({ children }) => {
