...
const SplashScreen = ({ onFinish }) => {
  ...
  const steps = [
    ...
    },
    {
      ...
      subtitle: "Finding your perfect home",
    },
    {
      icon: <MapPin />,
      title: "Metro Cebu Focused",
      subtitle: "Best neighborhoods and properties",
    },
    {
      icon: <Building />,
      title: "Verified Listings",
      subtitle: "100% inspected properties",
    },
  ];
      ...
      {isVisible && (
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center w-full max-w-sm sm:max-w-md md:max-w-lg">
            ...
            >
              <div className="p-4 sm:p-5 md:p-6 bg-emerald-100 rounded-2xl sm:rounded-3xl">
                ...
                {steps.map((_, index) => (
                  <div
                    ...
                    className={`transition-all duration-300 ${
                      index === currentStep
                        ? "w-3 h-3 sm:w-4 sm:h-4 bg-emerald-500"
                        : index < currentStep
                          ? "w-2 h-2 sm:w-3 sm:h-3 bg-emerald-300"
            ...
            <div className="mt-auto pt-4 sm:pt-6 border-t border-gray-100 w-full">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="w-7 h-7 sm:w-8 sm:h-8 md:w-10 md:h-10 bg-emerald-500 rounded-lg sm:rounded-xl flex items-center justify-center">
