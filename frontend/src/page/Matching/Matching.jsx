...
// Splash Screen Component (inline)
  ...
  const steps = [
    {
      ...
      subtitle: "We're tailoring recommendations just for you",
      color: "from-green-500 to-emerald-500",
    },
    {
      icon: <MapPin className="w-16 h-16" />,
      title: "Analyzing Preferences",
      subtitle: "Understanding your lifestyle and budget needs",
      color: "from-blue-500 to-cyan-500",
    },
    {
      icon: <Building className="w-16 h-16" />,
      title: "Scanning Properties",
      subtitle: "Searching through thousands of verified listings",
      color: "from-purple-500 to-pink-500",
    },
    {
      icon: <CheckCircle className="w-16 h-16" />,
      title: "Ready to Explore",
      subtitle: "Your perfect matches are being prepared",
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center justify-center w-full max-w-2xl px-6">
            ...
            <motion.div variants={itemVariants} className="text-center">
              ...
              >
                Preparing your matching experience
              </motion.p>
        ...
        <div className="mb-8">
          <div className="flex items-center gap-2 mb-6">
            <div className="w-8 h-8 flex items-center justify-center rounded">
              <img src={logo} alt="Livora Logo" className="h-6" />
            </div>
